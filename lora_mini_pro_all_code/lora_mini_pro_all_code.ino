...
DHT dht(DHTPIN, DHTTYPE);
 ...
 String BAND = "400";       // ตั้งค่า ยานความถี่รับส่งข้อมูล
 String SerialNumber= "";  
 String eband = "";
...
float airthreshold[3] = {
 ...
 int i = 5;
 char HP ; 
 byte Address = 0x5;         // ตั้งค่า Address อุปกรณ์ตัวsensor
